    	...
    	<form  method="post" name="formm" id="theform"> 
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="product_images/${productVO.image}" class="image-popup prod-img-bg"><img src="product_images/${productVO.image}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h1>${productVO.name}</h1>
					<hr>
					<h4><p><b>판매가</b></p><p class="price"  style="text-decoration: line-through; color: gray;"><fmt:formatNumber type="currency" value="${productVO.price1}"/></p></h4>
    				<h4><p><b>Bella 회원가</b></p><p class="price"><fmt:formatNumber type="currency" value="${productVO.price2}"/></p></h4>
    				<h4><b>무이자할부</b>  &nbsp;&nbsp; 최대 12개월</h4>
    				<h4><b>배송비</b>  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 무료</h4>
    				<h4><b>예상 수령일</b>  &nbsp;&nbsp; 7일 이내 수령 가능</h4>
    				<hr>
    				<h4><b>수 량 : </b></h4>
			       ...
			       <div id="buttons">
			       		<input type="button" value="BUY NOW"   class="submit btn btn-black py-3 px-5 mr-2"    onclick="go_cart()"> 
			       </div>                    	
         ...
         <div class="goods-view__detail--contnet" style="margin: 1rem 0 4rem; text-align: center;">
            <div class="goods-view__goods-images">                                                  
				<picture>		
