 ...
 <body class="goto-here">
    ...
    <!--  body 부분 -->
     ...
     <section class="ftco-section bg-light">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last"> <!--  상품 리스트 -->
    				<div class="row">
					...
					<div class="panel panel-default">
                         <div class="panel-heading">
                             <h4 class="panel-title">
                               	      <ul>
								        <li>
								          <a href="category?kind=1">크로스백</a>
								        </li>  
								        <li>
								          <a href="category?kind=2">클러치백</a>
								        </li>  
								        <li>
								          <a href="category?kind=3">파우치백</a>
								        </li> 
								        <li>
								          <a href="category?kind=4">토트백</a>
								        </li> 
								        <li>
								          <a href="category?kind=5">버킷백</a>
								        </li>  
								      </ul>  
                             </h4>
                         </div>
