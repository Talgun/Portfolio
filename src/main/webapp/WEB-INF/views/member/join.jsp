        ...
        <div class="row justify-content-center">
          <div class="col-xl-10 ftco-animate">
	          	...
	          	<div class="row align-items-end">
	          	  <div class="col-md-6">
	                 <div class="form-group">
	                  ...
	                  <input type="text" class="form-control" name="id"  id="id" value="${id}"  size="12">
	                  <input type="button"    value="중복 체크"  class="btn btn-primary py-3 px-4" onclick="idcheck()">
	                	...
	                	<div class="address_wrap">
		                	<div class="address_input_1_wrap">
		                		<div class="address_button" onclick="execution_daum_address()">
		                			<input type="button"     value="주소 찾기" class="btn btn-primary py-3 px-4"><br>
		                		</div>
		                		<div class="address_input_1_box">
		                  			<input type="text" class="form-control address_input_1" name="address1" size="10" readonly="readonly"><br>	
		                		</div>	                		
		                		<div class="clearfix"></div>
		                	</div>
		                	<div class="address_input_2_wrap">
		                		<div class="address_input_2_box">
		               				<input type="text" class="form-control address_input_2" name="address2" size="50" readonly="readonly"><br> 		
		                		</div>
		                	</div>
		                  	<div class="address_input_3_wrap">
		                		<div class="address_input_3_box">
		               				<input type="text" class="form-control address_input_3" name="address3" size="25" readonly="readonly"><br>				
		                		</div>
		                	</div>
	                  	</div>
              ...
              <div class="w-100"></div>
               ...
               <div id="buttons">
			        <input type="button"    value="회원가입"   class="submit btn btn-primary py-3 px-4" onclick="go_save()"> 
			        <input type="reset"      value="취소"     class="cancel btn btn-primary py-3 px-4">
			   </div>
